...
vantage is licensed under the **Apache License 2.0** (`LICENSE`). Under
section 5 of that license, a contribution you intentionally submit is made
under the same license, with no additional terms. There is nothing else to
sign or agree to.
